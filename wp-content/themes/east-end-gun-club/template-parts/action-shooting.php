<?php
/**
 * Template Name: Action Shooting Page
 */
...
get_header(); ?>
    ...
    <section class="container-fluid pt-5 pb-5 p-2 mainSection align-items-end" style="background-image: url('<?php echo esc_url(get_template_directory_uri() . '/assets/images/newImg33.webp'); ?>');">
            ...
            <div class="d-flex gap-5 align-items-lg-end">
                <div class="w-100">
                    <div class="titleSec" style="background-image: url('<?php echo esc_url(get_template_directory_uri() . '/assets/images/newImg25.webp'); ?>');">
                        <h3 class="subTitleWht-h3">ACTION SHOOTING</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="container-fluid pt-5 pb-5 p-2">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-12 d-flex flex-column gap-3 justify-content-center mb-lg-0 mb-4">
                    <h3 class="subTitle-h3">explore ACTION SHOOTING</h3>
                    <p>Get Your Adrenaline Pumping At Our Action Shooting Area, Designed For Dynamic Shooting Disciplines Including USPSA, IDPA, And 3-Gun Competitions. This Specialized Range Features Versatile Stage Configurations That Can Be Customized For Various Scenarios And Skill Levels. Test Your Speed, Accuracy, And Tactical Decision-Making In A Safe And Exciting Competitive Environment That Keeps Shooters Coming Back For More.</p>
                </div>
                <div class="col-lg-8 col-12">
                    <img class="w-100" src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/newImg34.webp'); ?>">
                </div>
            </div>
        </div>
    </section>
