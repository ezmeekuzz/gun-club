<?php
/**
 * Template Name: Trap 5 Stand Page
 */
...
get_header(); ?>
    ...
    <section class="container-fluid pt-5 pb-5 p-2 mainSection align-items-end" style="background-image: url('<?php echo esc_url(get_template_directory_uri() . '/assets/images/newImg31.webp'); ?>');">
            ...
            <div class="d-flex gap-5 align-items-lg-end">
                <div class="bnrTop">
                    <div class="titleSec" style="background-image: url('<?php echo esc_url(get_template_directory_uri() . '/assets/images/newImg5.webp'); ?>');">
                        <h3 class="subTitleWht-h3">Trap/5 Stand</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-12 d-flex flex-column gap-3 justify-content-center mb-lg-0 mb-4">
                    <h3 class="subTitle-h3">explore Trap/5 Stand</h3>
                    <p>Challenge Yourself At Our Dynamic Shotgun/5 Stand Facility Where Clay Targets Simulate The Unpredictable Flight Patterns Of Game Birds. This Versatile Range Offers Multiple Shooting Positions And Target Presentations To Keep Even The Most Experienced Shooters Engaged. Perfect For Improving Your Wing-Shooting Skills Or Simply Enjoying A Round With Friends, Our Shotgun Range Delivers Excitement With Every Pull Of The Trigger.</p>
                </div>
                <div class="col-lg-8 col-12">
                    <img class="w-100" src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/newImg32.webp'); ?>">
                </div>
            </div>
        </div>
    </section>
