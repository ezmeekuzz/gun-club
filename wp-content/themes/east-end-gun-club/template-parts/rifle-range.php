<?php
/**
 * Template Name: Rifle Range Page
 */
...
get_header(); ?>
    ...
    <section class="container-fluid pt-5 pb-5 p-2 mainSection align-items-end" style="background-image: url('<?php echo esc_url(get_template_directory_uri() . '/assets/images/newImg27.webp'); ?>');">
            ...
            <div class="d-flex gap-5 align-items-lg-end">
                <div class="bnrTop">
                    <div class="titleSec" style="background-image: url('<?php echo esc_url(get_template_directory_uri() . '/assets/images/newImg5.webp'); ?>');">
                        <h3 class="subTitleWht-h3">RIFLE RANGE</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-12 d-flex flex-column gap-3 justify-content-center mb-lg-0 mb-4">
                    <h3 class="subTitle-h3">explore RIFLE RANGE</h3>
                    <p>Our Meticulously Maintained Rifle Range Offers Shooters A Premier Experience With Multiple Firing Positions And Distances. From Sighting In Your Hunting Rifle To Fine-Tuning Your Long-Range Precision, Our Facility Provides The Perfect Environment For Shooters Of All Abilities. With Target Distances Extending To 300 Yards, You'll Have Ample Opportunity To Test Your Marksmanship And Improve Your Skills In The Beautiful Milton-Freewater Countryside.</p>
                </div>
                <div class="col-lg-8 col-12">
                    <img class="w-100" src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/newImg28.webp'); ?>">
                </div>
            </div>
        </div>
    </section>
