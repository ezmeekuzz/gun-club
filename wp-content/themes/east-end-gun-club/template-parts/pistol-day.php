...
get_header(); ?>
    ...
    <section class="container-fluid pt-5 pb-5 p-2 mainSection align-items-end" style="background-image: url('<?php echo esc_url(get_template_directory_uri() . '/assets/images/newImg24.webp'); ?>');">
            ...
            <div class="d-flex gap-5 align-items-lg-end">
                <div class="bnrTop">
                    <div class="titleSec" style="background-image: url('<?php echo esc_url(get_template_directory_uri() . '/assets/images/newImg5.webp'); ?>');">
                        <h3 class="subTitleWht-h3">PISTOL BAYS</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-12 d-flex flex-column gap-3 justify-content-center mb-lg-0 mb-4">
                    <h3 class="subTitle-h3">explore PISTOL BAYS</h3>
                    <p>Our Dedicated Pistol Bays Provide The Ideal Environment For Handgun Enthusiasts To Practice Safely And Effectively. Multiple Shooting Bays Allow For Individual Or Small Group Practice Without Disruption. Whether You're Working On Your Draw, Perfecting Your Aim, Or Running Drills, Our Well-Designed Pistol Range Accommodates All Skill Levels From Beginners To Advanced Shooters.</p>
                </div>
                <div class="col-lg-8 col-12">
                    <img class="w-100" src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/newImg23.webp'); ?>">
                </div>
            </div>
        </div>
    </section>
