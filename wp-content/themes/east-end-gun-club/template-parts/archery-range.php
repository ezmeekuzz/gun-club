<?php
/**
 * Template Name: Archer Range Page
 */
...
get_header(); ?>
    ...
    <section class="container-fluid pt-5 pb-5 p-2 mainSection align-items-end" style="background-image: url('<?php echo esc_url(get_template_directory_uri() . '/assets/images/newImg29.webp'); ?>');">
            ...
            <div class="d-flex gap-5 align-items-lg-end">
                <div class="bnrTop">
                    <div class="titleSec" style="background-image: url('<?php echo esc_url(get_template_directory_uri() . '/assets/images/newImg5.webp'); ?>');">
                        <h3 class="subTitleWht-h3">ARCHERY RANGE</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-12 d-flex flex-column gap-3 justify-content-center mb-lg-0 mb-4">
                    <h3 class="subTitle-h3">explore ARCHERY RANGE</h3>
                    <p>Find Your Focus At Our Archery Range, Where Traditional And Modern Bow Hunters Alike Can Perfect Their Craft. Our Range Features Multiple Shooting Lanes And 3D Targets Set In Naturalistic Settings To Simulate Hunting Scenarios. Whether You're Shooting Recurve, Compound, Or Crossbow, Our Archery Facilities Offer The Perfect Place To Hone Your Skills Year-Round.</p>
                </div>
                <div class="col-lg-8 col-12">
                    <img class="w-100" src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/newImg30.webp'); ?>">
                </div>
            </div>
        </div>
    </section>
